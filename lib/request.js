...
var logger = require('./log').getLogger('request');
var Promise = require('bluebird');
var request = require('request');

// TODO: Make the throttleWindow more configurable...
// (probably by fixing cached-request, honestly)
var throttleWindow = 1; // 100;
var cacheDirectory = path.join(__dirname, '../request-cache');
var defaultTtl = 1000 * 60 * 60 * 24 * 30;  // cache for a month by default

var throttledRequest = require('throttled-request')(request);

throttledRequest = throttledRequest.defaults({
...
var promisedRequest = Promise.promisify(cachedRequest, { multiArgs: true });
